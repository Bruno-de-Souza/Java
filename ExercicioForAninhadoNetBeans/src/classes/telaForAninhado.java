 ...
 * @author bruno
 */
public class telaForAninhado extends javax.swing.JFrame {

    /**
     * Creates new form telaForAninhado
     */
    public telaForAninhado() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(telaForAninhado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new telaForAninhado().setVisible(true);
            }
        });
    }
